...
const {addDomain, getAllDomains, updateDomain, fetchSingleDomain, deleteDomain, uploadDomains} = require("../Controller/domainController")
...
router.post('/upload',token, uploadDomains);
